...
**AdamW ([`AdamWConfig`](/api-reference/optimizer-configs#adamwconfig))** (recommended for most cases):
...
**Cosine Decay with Warmup ([`CosineDecayWithWarmupConfig`](/api-reference/optimizer-configs#cosinedecaywithwarmupconfig))** (recommended for most cases):
...
**Cosine Annealing with Warm Restarts ([`CosineAnnealingWarmRestartsConfig`](/api-reference/optimizer-configs#cosineannealingwarmrestartsconfig))**:
